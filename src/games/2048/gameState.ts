...
export const createGame2048 = (random = Math.random): Game2048Save => ({ version: GAME_2048_SAVE_VERSION, board: newBoard(random), score: 0, best: 0, over: false, won: false, updatedAt: Date.now() })
